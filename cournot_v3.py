...
#vectorised 2P-3T cournot 

#vectorize... check?
#add second period...
#xn is now the subgame strategy for player n.
#let's make something 3 turns long
#let's just get 2x3 basic thing like before then we'll add complicated period stuff
...
def reaction(x_allmn,cn,b,n):
    ...
    xn = optimize.brute(profit, ((0.3,0.4),(0.3,0.4),(0.3,0.35)), args = (x_allmn,n,cn,b))
...
def main():
    ...
    #i.e. x_arr - f(x_arr) = 0
    ans = optimize.fsolve(vector_reaction, x0, args = (param), xtol = 1e-08)
    print 'ans'
    print ans
